...
" GUI
highlight Typedef           guibg=grey15     guifg=#00ff8c
highlight StorageClass      guibg=grey15     guifg=#a0db35
highlight BuildInFunction   guibg=grey15     guifg=#00d5d5
highlight Sysvars           guibg=grey15     guifg=white
highlight Movement          guibg=grey15     guifg=green
highlight Continue          guifg=#646423
highlight Operator          guibg=grey15     guifg=#c84600
highlight Exception         guibg=grey15     guifg=Orange
highlight BadWhitespace     guibg=#ff0000     guifg=#ff0000
...
hi Folded		guibg=grey15 guifg=yellowgreen
hi vimFold		guibg=grey15 guifg=yellowgreen
hi FoldColumn	guibg=grey15 guifg=yellowgreen
hi CommentFold	guibg=#000000 guifg=yellowgreen

hi LineNr		guifg=#535353 guibg=#202020
hi NonText		guifg=#535353 guibg=#202020
"hi FoldeColumn  guifg=#535353 guibg=#202020 gui=bold
hi FoldeColumn  guibg=grey15 guifg=yellowgreen
