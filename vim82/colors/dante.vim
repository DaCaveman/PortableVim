...
hi Folded	term=standout ctermfg=blue ctermbg=white guifg=royalblue1 guibg=black
hi FoldColumn	term=standout ctermfg=blue ctermbg=white guifg=royalblue3 guibg=black
